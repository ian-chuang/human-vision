    ...
    for batch in tqdm.tqdm(dataloader, total=len(dataloader)):
        ...
        for i in range(len(batch["index"])):
            ...
            for key in dataset.meta.camera_keys:
                ...
                if ("left_eye_cam" in key or "zed_cam_left" in key) and "left_eye" in batch:
                    eye = batch['left_eye'][i]
                elif ("right_eye_cam" in key or "zed_cam_right" in key) and "right_eye" in batch:
                    eye = batch['right_eye'][i]
                else:
                    eye = None
                ...
                if eye is not None:
                    ...
                    cross_size = 5  # Length of cross arms in pixels
                    ...
                    img = cv2.line(img, (x - cross_size, y - cross_size), (x + cross_size, y + cross_size), color, thickness)
                    img = cv2.line(img, (x - cross_size, y + cross_size), (x + cross_size, y - cross_size), color, thickness)
