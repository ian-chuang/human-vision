...
def get_policy_class(name: str) -> PreTrainedPolicy:
    ...
    if name == "tdmpc":
        ...
        from lerobot.common.policies.flare.modeling_flare import FlarePolicy
...
def make_policy(
    ...
    cfg.input_features = {
        ...
        if key not in cfg.output_features and key in cfg.observation_keys
    }
    kwargs["config"] = cfg
